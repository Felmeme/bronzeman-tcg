 ...
 * "Show meets reqs" filter and the quest hover, and never restricts anything in game.
 *
...
public class QuestRequirementCatalog
{
	...
	{
		try (InputStream stream = getClass().getResourceAsStream("/quest_requirements.json"))
		{
			if (stream == null)
			{
